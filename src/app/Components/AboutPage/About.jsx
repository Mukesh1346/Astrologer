...
import Rashifal from "@/app/Assets/Images/Rashifal.png";
import "./About.css";
          ...
          <div className="row">
            <div className="pagetop py-2">
              ...
              <div className="changepage">
                <p>
                  <Link onClick={handleActiveChange} href="/" className="render">
                    Home
                  </Link>{" "}
                  <span>
                    <FaAngleRight /> About
        ...
        <div className="container-fluid pt-3">
          <div className="row">
            <div className="designstar mt-2">
              <Image src={Designstar} alt="Design star" />
            </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="Rashifal">
                <Image src={Rashifal} alt="Rashifal" />
              </div>
            </div>
